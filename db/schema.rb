...
ActiveRecord::Schema.define(version: 2019_05_21_082059) do

  create_table "favorite_relationships", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id"
